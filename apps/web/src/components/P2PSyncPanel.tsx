    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div className="row gap-8 align-center" style={{ marginBottom: 12 }}>
          ...
          <h4 style={{ margin: 0, color: 'var(--gold)' }}>Sincronización Táctica P2P (Local & WebRTC)</h4>
        </div>

        {mode === 'idle' && (
          <div>
            <p className="muted" style={{ fontSize: 12.5, marginTop: 0, marginBottom: 16 }}>
              Intercambia tus quinielas y compite al instante con familiares o amigos cercanos utilizando una conexión directa de baja latencia.
            </p>
