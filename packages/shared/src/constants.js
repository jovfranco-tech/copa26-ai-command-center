...
export const MATCH_STATUSES = ['UPCOMING', 'LIVE', 'FT'];
...
export const ASSET_ENTITY_TYPES = ['team', 'player', 'venue', 'fifa'];
export const ASSET_TYPES = ['flag', 'crest', 'photo', 'venue_image', 'logo'];
export const ASSET_STATUSES = ['present', 'missing', 'error', 'placeholder'];
/**
...
export const FOOTER_NOTICE = 'Proyecto personal · sin afiliación oficial · datos públicos del torneo.';
...
export const MOCK_BANNER = 'Calendario real del torneo 2026. Plantillas, resultados y estadísticas aparecen cuando se jueguen los partidos (11 jun).';
